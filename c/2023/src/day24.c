...
void combine(__int128 M0[3][3], __int128 M1[3][3], __int128 M2[3][3], __int128 M3[3][3], __int128 M[6][6]) {
  ...
  M[3][0] = M1[0][0]; M[3][1] = M1[0][1]; M[3][2] = M1[0][2]; M[3][3] = M3[0][0]; M[3][4] = M3[0][1]; M[3][5] = M3[0][2];
  M[4][0] = M1[1][0]; M[4][1] = M1[1][1]; M[4][2] = M1[1][2]; M[4][3] = M3[1][0]; M[4][4] = M3[1][1]; M[4][5] = M3[1][2];
